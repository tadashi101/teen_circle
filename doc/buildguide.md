...
| コンデンサ10u 1608サイズ | 1 | Rev2から予備も含めて3つ入れてます |
| コンデンサ0.1u 1608サイズ | 10 | 1個余分に入ってるかも |
| ピンヘッダオス 2×3 1.27mmピッチ | 1 | Rev2から2.54mmピッチ |
| ネジ | 1 |  |
| スペーサー | 1 | (Rev2から廃止) |
| Tバー | 1 |  |
| ワッシャー | 1 | (Rev2から廃止) |
...
LED赤は240個、LED青は120個実装します。量が多い方がLED赤です  
...
LEDにはカソード側であることを示すマークがついています。このマークが円の内側になるように実装すれば、正しい向きに実装されます  
